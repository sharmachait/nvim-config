...
local java_version_output = vim.fn.system("java -version 2>&1")
local java_version = java_version_output:match('"%d+') or '"23'
java_version = java_version:gsub('"', "")
...
local config = {
  ...
  settings = {
    java = {
      home = java_home, -- adjust if different
